/*package com.independentwork.andrea.compostthemost.demo;

import android.support.v4.app.Fragment;

import com.independentwork.andrea.compostthemost.R;
import com.independentwork.andrea.compostthemost.util.sortResults;
    ...
    static {
        ...
        addDemoFeature("cloud_logic", R.mipmap.cloud_logic, R.string.feature_cloud_logic_title,
                ...
                new DemoItem(R.string.main_fragment_title_cloud_logic, R.mipmap.cloud_logic,
                        R.string.feature_cloud_logic_demo_button, sortResults.class));
    }
